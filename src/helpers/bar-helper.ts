...
const convertToBar = (
  ...
  const hideChildren = ( task.type === "project" || task.type === "Volet" || task.type === "Composante" || task.type === "Sous composante" )  && task.childrenCount !== undefined && task.childrenCount !== 0 ? task.hideChildren : undefined;
